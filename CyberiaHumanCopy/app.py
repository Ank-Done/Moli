...
def get_reporte_anio(agente=None):
    ...
    SUM(
        CASE
                WHEN p.CNOMBREPRODUCTO LIKE '%C/10 BOLSAS  1 KG%' THEN m.CUNIDADES * 10
                WHEN p.CNOMBREPRODUCTO LIKE '%C/10 BOLSAS  907 GRS.%' THEN m.CUNIDADES * (0.907*10)
                WHEN p.CNOMBREPRODUCTO LIKE '%C/20 BOLSAS  500.GR.%' THEN m.CUNIDADES * (0.5*20)
                WHEN p.CNOMBREPRODUCTO LIKE '%C/10 BOLSAS 2 LBS%' THEN m.CUNIDADES * (0.907*10)
                WHEN p.CNOMBREPRODUCTO LIKE '%KUA%' THEN m.CUNIDADES * 1
                WHEN p.CNOMBREPRODUCTO LIKE '%(KILOS)%' THEN m.CUNIDADES * 1
                WHEN p.CNOMBREPRODUCTO LIKE '%Sugar Warehousing, manufacturing and transload to bulk truck%' THEN m.CUNIDADES * 1000
                WHEN p.CNOMBREPRODUCTO LIKE '%X KG%' THEN m.CUNIDADES * 1
                WHEN p.CNOMBREPRODUCTO LIKE '%(LIBRAS)%' THEN m.CUNIDADES * 0.4535
            WHEN p.CNOMBREPRODUCTO LIKE '%1 KG%' OR p.CNOMBREPRODUCTO LIKE '%1KG%' OR p.CNOMBREPRODUCTO LIKE '%1. KG%' OR p.CNOMBREPRODUCTO LIKE '%1 %' THEN m.CUNIDADES * 1
            ...
            WHEN p.CNOMBREPRODUCTO LIKE '%907%' OR p.CNOMBREPRODUCTO LIKE '%2 LB%' THEN m.CUNIDADES * 0.907
            WHEN p.CNOMBREPRODUCTO LIKE '%500%' OR p.CNOMBREPRODUCTO LIKE '%0.5 KG%' THEN m.CUNIDADES * 0.5
            ...
            WHEN p.CNOMBREPRODUCTO LIKE '%1000 KG%' THEN m.CUNIDADES * 0
            ELSE 0
        END
    ) AS KilosTotales,
    SUM(
