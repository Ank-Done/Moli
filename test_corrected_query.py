#!/usr/bin/env python3
"""
Script para probar la consulta SQL exacta del usuario con corrección de precedencia
"""
...
def test_corrected_query():
    """Ejecuta la consulta SQL del usuario con corrección de precedencia de operadores"""
    ...
    # CONSULTA EXACTA DEL USUARIO con corrección de precedencia
    query = """
    SELECT
    ...
    print("RESULTADOS DE LA CONSULTA CORREGIDA:")
    print("===================================")
    ...
    for ref_anio, ref_mes, ref_kilos, ref_toneladas in ref_data:
        ...
        if not query_row.empty:
            ...
            precision_kg = (1 - abs(ref_kilos - q_kilos) / ref_kilos) * 100
            precision_ton = (1 - abs(ref_toneladas - q_toneladas) / ref_toneladas) * 100
            ...
            print(f"  Precisión:  {precision_kg:.2f}% kg, {precision_ton:.2f}% ton")
            print()
        else:
